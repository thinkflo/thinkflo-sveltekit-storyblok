...
<section class="bg-gray-200 relative">
  <Constrained_Width>
    ...
    <div class="flex justify-center space-x-6">
      <!-- Unmuted -->
      <svg class="w-10 h-10 cursor-pointer" class:hidden={audioElement?.muted} on:click={handleMute} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Play Button -->
      <svg class="w-10 h-10 cursor-pointer fill-white" class:hidden={!audioElement?.paused} on:click={handlePlay} version="1.1" viewBox="0 0 36 36" width="100%"><use class="ytp-svg-shadow" xlink:href="#ytp-id-53"></use><path class="ytp-svg-fill" d="M 12,26 18.5,22 18.5,14 12,10 z M 18.5,22 25,18 25,18 18.5,14 z" id="ytp-id-53"></path></svg>
      <!-- Pause Button -->
      <svg class="w-10 h-10 cursor-pointer fill-white" class:hidden={audioElement?.paused} on:click={handlePlay} version="1.1" viewBox="0 0 36 36" width="100%"><use class="ytp-svg-shadow" xlink:href="#ytp-id-63"></use><path class="ytp-svg-fill" d="M 12,26 16,26 16,10 12,10 z M 21,26 25,26 25,10 21,10 z" id="ytp-id-63"></path></svg>
      
      <!-- Restart Button -->
      <svg class="w-10 h-10 cursor-pointer" on:click={handleReset} viewBox="0 0 102 120" fill="none" xmlns="http://www.w3.org/2000/svg">
